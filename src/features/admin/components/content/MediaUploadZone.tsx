    ...
    <div className="space-y-3">
      ...
      <div className="rounded-xl border-2 border-dashed border-border bg-muted/10 py-16 flex flex-col items-center justify-center gap-3">
        ...
        <div className="text-center space-y-1">
          <p className="text-sm font-medium text-foreground">Upload will be available soon</p>
          <p className="text-xs text-muted-foreground max-w-xs">
            Media upload functionality will be enabled after backend integration is complete. Save
            as draft and come back to upload later.
          </p>
        </div>
        <button
          type="button"
