...
export function ResetPasswordPage() {
  ...
  const resendMutation = useMutation({
    ...
    // Note: resend by userId not easily possible here without email.
    // We set a dummy; if the user needs to resend, they go back to forgot-password page.
  });
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-background px-4">
        <div className="text-center">
          ...
          <Link to="/forgot-password" className="mt-4 inline-block text-sm font-medium text-violet-light hover:underline">
      ...
      >
        ...
        <div className="rounded-2xl border border-border bg-card/60 p-8 backdrop-blur-xl">
          ...
          <form onSubmit={onSubmit} className="space-y-5" id="reset-password-form">
            {/* OTP Inputs */}
            <div>
              <label className="mb-2 block text-sm font-medium text-foreground/80">Verification Code</label>
        ...
        <p className="mt-8 text-center text-sm text-muted-foreground">
          <Link to="/login" className="inline-flex items-center gap-1 font-medium text-violet-light hover:underline">
